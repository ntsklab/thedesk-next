...
import Posts, { type FuncProps as PostsFunc } from './profile/Posts'
...
const profileMenu = ({ className, left, top, onClose, client, myself, user, relationship, onChange, openAddListMember }: ProfileMenuProps, ref: React.RefCallback<HTMLElement>): ReactElement => {
